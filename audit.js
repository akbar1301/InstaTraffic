(async () => {
    ...
    [span_0](start_span)[span_1](start_span)[span_2](start_span)[span_3](start_span)// Daftar target berdasarkan log dirsearch kamu[span_0](end_span)[span_1](end_span)[span_2](end_span)[span_3](end_span)
    const targets = [
        '/ocp.php', 
        '/.env', 
        '/admin/', 
    ...
    for (const path of targets) {
        try {
            ...
            [span_4](start_span)// Jika ocp.php terbuka, ambil sedikit cuplikan isinya[span_4](end_span)
